...
//            ),
        ...
        if ($request->isPost() && $request->getPost('task') === 'save') {
            ...
            try {
                ...
                if ($form->getElement('photo_gallery_leading_photo')->isUploaded()) {
                    ...
                    //$fileInfo = $_FILES['photo_gallery_leading_photo']; moze i ovako
                }
    ...
    public function dashboardAction () {
        ...
        $photoGalleriesTotal = $cmsPhotoGalleriesDbTable->count(array(
            'orders' => array(
                'order_number' => 'ASC'
                )
        ));
        
        $photoGalleriesActive = $cmsPhotoGalleriesDbTable->count(array(
            'status' => Application_Model_DbTable_CmsPhotoGalleries::STATUS_ENABLED
        ));
        
        $this->view->photoGalleriesTotal = $photoGalleriesTotal;
        $this->view->photoGalleriesActive = $photoGalleriesActive;
