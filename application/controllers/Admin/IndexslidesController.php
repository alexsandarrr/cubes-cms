...
//            ),
    ...
    public function addAction () {
        ...
        if ($request->isPost() && $request->getPost('task') === 'save') {
            ...
            try {
                ...
                // remove key index_slide_photo from form data because there is no column 'index_slide_photo' in cms_indexSlides table
                ...
                if ($form->getElement('index_slide_photo')->isUploaded()) {
                    ...
                    //$fileInfo = $_FILES['index_slide_photo']; moze i ovako
                }
    ...
    public function dashboardAction () {
        ...
        $indexSlidesTotal = $cmsIndexSlidesDbTable->count(array(
            'orders' => array(
                'order_number' => 'ASC'
                )
        ));
        
        $indexSlidesActive = $cmsIndexSlidesDbTable->count(array(
            'status' => Application_Model_DbTable_CmsIndexSlides::STATUS_ENABLED
        ));
        
        $this->view->indexSlidesTotal = $indexSlidesTotal;
        $this->view->indexSlidesActive = $indexSlidesActive;
