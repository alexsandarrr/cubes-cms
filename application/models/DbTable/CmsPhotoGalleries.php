...
class Application_Model_DbTable_CmsPhotoGalleries extends Zend_Db_Table_Abstract
{
    ...
    public function insertPhotoGallery ($photoGallery) {
        ...
        $photoGalleryWithBiggerstOrderNumber = $this->fetchRow($select);
        
        if ($photoGalleryWithBiggerstOrderNumber instanceof Zend_Db_table_Row) {
            
            $photoGallery['order_number'] = $photoGalleryWithBiggerstOrderNumber['order_number'] + 1;
