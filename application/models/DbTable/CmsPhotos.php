...
class Application_Model_DbTable_CmsPhotos extends Zend_Db_Table_Abstract
{
    ...
    public function insertPhoto ($photo) {
        ...
        $photoWithBiggerstOrderNumber = $this->fetchRow($select);
        
        if ($photoWithBiggerstOrderNumber instanceof Zend_Db_table_Row) {
            
            $photo['order_number'] = $photoWithBiggerstOrderNumber['order_number'] + 1;
