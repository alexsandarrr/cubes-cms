...
class Application_Model_DbTable_CmsIndexSlides extends Zend_Db_Table_Abstract
{
    ...
    public function insertIndexSlide ($indexSlide) {
        ...
        $indexSlideWithBiggerstOrderNumber = $this->fetchRow($select);
        
        if ($indexSlideWithBiggerstOrderNumber instanceof Zend_Db_table_Row) {
            
            $indexSlide['order_number'] = $indexSlideWithBiggerstOrderNumber['order_number'] + 1;
